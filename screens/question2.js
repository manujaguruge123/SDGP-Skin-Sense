...
const Question2 = ({ navigation }) => {
  const question = 'Have you noticed any of these sensations on your skin?';
  const answers = ['   Burning', '   Tingling', '   Numbness', '   None of the above'];
  ...
  return (
    ...
    >
      <View style={styles.container}>
        <Text style={styles.headerText}>Second One....</Text>
        ...
        <View style={styles.bottomContainer}>
          <Text style={styles.pageNumber}>2 of 4</Text>
