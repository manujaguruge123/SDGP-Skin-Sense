...
const Question3 = ({ navigation }) => {
  const question = 'How would you describe the texture of your skin?';
  const answers = ['   Rough', '   Smooth', '   Flaky', '   Bumpy'];
  ...
  return (
    ...
    >
      <View style={styles.container}>
        <Text style={styles.headerText}>Third One....</Text>
        ...
        <View style={styles.bottomContainer}>
          <Text style={styles.pageNumber}>3 of 4</Text>
